      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 py-6 md:py-10 lg:py-14">
        <div className="grid lg:grid-cols-[1fr_340px] gap-6 lg:gap-8">
          ...
          <div className="relative aspect-[4/3] md:aspect-[16/9] lg:aspect-auto lg:min-h-[560px] overflow-hidden">
            <HeroSlideshow />
            <div className="absolute bottom-3 left-3 md:bottom-8 md:left-8 lg:bottom-10 lg:left-10 z-10 bg-white/75 backdrop-blur-md rounded-sm px-3 py-2.5 md:p-7 lg:p-8 max-w-[220px] md:max-w-none">
              <h1 className="text-[15px] md:text-3xl lg:text-4xl font-light leading-[1.6] tracking-normal text-neutral-900">
                住まいの「きれい」を
                <br />
                届けて16年。
              </h1>
              <p className="text-neutral-500 text-[10px] md:text-sm mt-1 md:mt-3 leading-relaxed">
                山中湖村を拠点に、富士五湖エリアで
